...
# Здесь можно указать несколько конфигов и запустить их в цикле. Обучение будет выполняться по очереди.
config_path = ('../config_for_train_gazebo.json',)
for cfg_path in config_path:
    trainer(config_path = cfg_path)
