...
pred_main_path = "/media/ivan/Seagate Backup Plus Drive/check/nissan-eval/data"
pred_dirs = ["data_1-1", "data_2-1", "data_2-2", "data_2-3", "data_2-4"]

result_main_path = "/media/ivan/Seagate Backup Plus Drive/check/nissan-eval/yolo"
result_dirs = ["1-1", "2-1", "2-2", "2-3", "2-4"]

pred_dir = pred_dirs[DATASET_ID]

img_for_pred = '{0}/{1}/'.format(pred_main_path, pred_dir)
img_results  = '{0}/{1}_{2}/'.format(result_main_path, c_dir, result_dirs[DATASET_ID])
